      ...
      <div className="flex flex-col gap-3">
            ...
            <div className="bg-white shadow-md grid  max-md:grid-cols-1 max-2xl:grid-cols-7   p-4 gap-3 rounded-md">
              ...
              <div className="  max-md:col-span-1 max-2xl:col-span-5 flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between max-sm:items-end">
                  ...
                  <button className="bg-[#283BBE] text-white px-5 py-1 rounded max-md:text-[10px] max-2xl:text-[13px]">
                    Details
                  </button>
                </div>
              </div>
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center gap-1 text-xs">
            <button className={`px-3 py-1 border-[1px] border-[#283BBE] bg-transparent text-[#283BBE]`}>
              Previous
            </button>
            <button className={`px-3 py-1 border-[1px] border-[#283BBE] bg-[#283BBE] text-white`}>1</button>
            <button className={`px-3 py-1 border-[1px] border-[#283BBE] bg-transparent text-[#283BBE]`}>2</button>
            <button className={`px-3 py-1 border-[1px] border-[#283BBE] bg-transparent text-[#283BBE]`}>3</button>
            <button className={`px-3 py-1 border-[1px] border-[#283BBE] bg-transparent text-[#283BBE]`}>Next</button>
          </div>
        </div>
      </div>
    </div>
